...
Storage::save_field_group( 'cpt_homepage', array(
	...
	'fields'     => array(
		...
		hf( 'compare_auxtech_title', 'Compare — Right Column Title' ),
		hf( 'compare_typical', 'Compare — Left Rows (one per line)', 'textarea' ),
		hf( 'compare_auxtech', 'Compare — Right Rows (one per line)', 'textarea' ),
...
$id = wp_insert_post( wp_slash( array(
	...
	'meta_input'  => array(
		...
		'compare_heading'         => 'The usual way, or the Auxtech way.',
		'compare_typical_title'   => 'A typical agency',
		'compare_auxtech_title' => 'Auxtech',
