  ...
  return (
    <SiteShell theme={pageThemes["our-story"]}>
        ...
        <div className="container-page grid items-end gap-12 py-24 md:grid-cols-[1.1fr_0.9fr] md:py-32">
          <div>
            ...
            <h1
              ...
              data-reveal
            >
              Built to bridge engineering and <span className="text-gold">growth</span>.
            </h1>
            <p className="mt-7 max-w-md text-lg leading-relaxed text-muted-foreground" data-reveal>
              We started Northline in 2014 to prove that craft, speed, and business outcomes
              aren't a trade-off.
            </p>
          </div>
      ...
      <section className="block-light">
        <div className="container-page border-t border-border py-28" data-reveal-group>
          <div className="mb-16 max-w-3xl">
            <p className="text-xs uppercase tracking-[0.28em] text-gold" data-reveal-child>The journey</p>
            <h2 className="mt-4 font-display text-4xl font-semibold leading-tight md:text-6xl" data-split>
              A decade, drawn as one line.
            </h2>
          </div>
      ...
      <section className="block-bold">
        <div className="container-page grid items-start gap-16 py-24 md:grid-cols-2 md:py-28">
          ...
          <div className="space-y-5 text-lg leading-relaxed text-muted-foreground" data-slide="right">
            <p>
              Growth was never the goal — the work was. Every seat at Northline is senior:
              no juniors, no handoffs, no account managers translating between you and the
              people building your product.
            </p>
            <p>
              That's why the numbers hold. 84% of clients continue with us on a Care plan
              after launch, and client retention has stayed at 98% for years. First demo on
              day 7, a shippable slice by day 14 — same promise since 2014.
            </p>
          </div>
        </div>
      </section>
      ...
      <CTABand
        ...
        subtitle="Build the next milestone with us — as a client, or from the inside."
        primary={{ label: "Explore Careers", to: "/careers" }}
