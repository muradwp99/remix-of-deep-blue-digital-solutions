          ...
          <div className="mt-12 grid max-w-5xl gap-8 lg:grid-cols-[1fr_1.1fr]" data-reveal>
            ...
            <ResultPanel>
              ...
              <button
                ...
                onClick={analyse}
                disabled={thinking}
                className="mt-8 rounded-xl bg-gold px-7 py-3.5 font-display text-sm font-bold uppercase tracking-wider text-[#10142b] transition-transform hover:brightness-105 active:scale-[0.98] disabled:opacity-40"
              >
